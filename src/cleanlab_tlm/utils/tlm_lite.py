...
class TLMLite:
    ...
    def try_prompt(
        ...
        prompt_succeeded_mask = np.array(
            [res["response"] is not None for res in prompt_response]
        )
        ...
        perplexity_succeeded = [
            r["log"]["perplexity"] for r in prompt_response_succeeded
        ]
